...
mod node {
    ...
    #[test]
    fn test_get_zid() {
        let node = Node::new("node_test1",(-1.,-1.));
    ...
    fn test_get_neighbours() {
        let node = Node::new("node_test2",(-1.,-1.));
    ...
    #[test]
    fn test_get_polygon() {
        let node = Node::new("node_test3",(-1.,-1.));
    ...
    fn test_is_in_polygon() {
        let node = Node::new("node_test4",(-1.,-1.));
    ...
    #[test]
    fn test_get_status() {
        let node = Node::new("node_test5",(-1.,-1.));
